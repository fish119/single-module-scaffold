...
-- 系统用户
INSERT INTO `sys_user` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `is_account_non_expired`, `is_account_non_locked`, `is_credentials_non_expired`, `is_enabled`, `password`, `username`) VALUES (1, NULL, '2021-01-30 19:00:35.000000', NULL, NULL, 1, 1, 1, 1, '{noop}21232f297a57a5a743894a0e4a801fc3', 'admin');
INSERT INTO `sys_user` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `is_account_non_expired`, `is_account_non_locked`, `is_credentials_non_expired`, `is_enabled`, `password`, `username`) VALUES (2, 'admin', '2021-01-30 19:03:46.000000', NULL, NULL, 1, 1, 1, 1, '{bcrypt}$2a$10$H0AedsdZnYHdCT11KHfpB.4/NDj7dLb.3X9pvXm4.tHU0XSf22ABa', 'test');
-- 关系表
